...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, readBody, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, getResponseStatusText } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/radix3/dist/index.mjs';
import { generateJSON } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/@intlify/bundle-utils/index.mjs';
import { relative, join } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/pathe/dist/index.mjs';
import { version, unref } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/server/assets"}];
...
storage.mount('i18n', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/.nuxt/i18n","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _LYBrqa = defineEventHandler(async (event) => {
...
const _VMhcbg = defineEventHandler(async (event) => {
...
const _lazy_tyoCG5 = () => Promise.resolve().then(function () { return index$1; });
const _lazy_wc0Hyc = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api', handler: _lazy_tyoCG5, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_wc0Hyc, lazy: true, middleware: false, method: undefined },
  { route: '/__i18n__/precompile', handler: _LYBrqa, lazy: false, middleware: false, method: "post" },
  { route: '/__i18n__/prerender/:hash', handler: _VMhcbg, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_wc0Hyc, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/bounadiallo/Desktop/Epitech_Tek3/HUB/StillWatch/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
