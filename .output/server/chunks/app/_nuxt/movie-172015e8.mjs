...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/genre/_id/movie.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const movie = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { movie as default };
//# sourceMappingURL=movie-172015e8.mjs.map
