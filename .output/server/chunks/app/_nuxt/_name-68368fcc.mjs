...
import { b as getTrending, i as getMovies, e as getListItem } from './tmdbAPI-af98a87a.mjs';
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/movie/category/_name.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _name = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { _name as default };
//# sourceMappingURL=_name-68368fcc.mjs.map
